...
where A.business_id = B.business_id and upper(a.state) = 'QC' AND B.STARS = 5 LIMIT 3000; 


INSERT INTO "YELP"."REVIEW_BALANCED"(REVIEW_ID, USER_ID, BUSINESS_ID,CITY, REVIEW_DATE,TEXT,STARS)
select b.review_id, b.user_id, b.business_id, a.city, b.review_date, b.text, b.stars
FROM "YELP".BUSINESS A, "YELP".review B
where A.business_id = B.business_id and upper(a.state) = 'QC' AND B.STARS = 4 LIMIT 3000; 

INSERT INTO "YELP"."REVIEW_BALANCED"(REVIEW_ID, USER_ID, BUSINESS_ID,CITY, REVIEW_DATE,TEXT,STARS)
select b.review_id, b.user_id, b.business_id, a.city, b.review_date, b.text, b.stars
FROM "YELP".BUSINESS A, "YELP".review B
where A.business_id = B.business_id and upper(a.state) = 'QC' AND B.STARS = 3 LIMIT 3000; 

INSERT INTO "YELP"."REVIEW_BALANCED"(REVIEW_ID, USER_ID, BUSINESS_ID,CITY, REVIEW_DATE,TEXT,STARS)
select b.review_id, b.user_id, b.business_id, a.city, b.review_date, b.text, b.stars
FROM "YELP".BUSINESS A, "YELP".review B
where A.business_id = B.business_id and upper(a.state) = 'QC' AND B.STARS = 2 LIMIT 3000; 

INSERT INTO "YELP"."REVIEW_BALANCED"(REVIEW_ID, USER_ID, BUSINESS_ID,CITY, REVIEW_DATE,TEXT,STARS)
select b.review_id, b.user_id, b.business_id, a.city, b.review_date, b.text, b.stars
FROM "YELP".BUSINESS A, "YELP".review B
where A.business_id = B.business_id and upper(a.state) = 'QC' AND B.STARS = 1 LIMIT 3000; 
...
SELECT  REVIEW_ID, TEXT, STARS FROM  "YELP"."REVIEW_VIEW"  LIMIT 11250;
...
SELECT  REVIEW_ID, TEXT, STARS FROM  "YELP"."REVIEW_VIEW"  LIMIT 3750 OFFSET 11250;
...
select count(*) from "YELP"."TEST_DATA";
...
select * from "PAL_DEV"."COMPARE_NB"
